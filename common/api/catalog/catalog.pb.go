...
type LaptopCard struct {
	...
	Featured    float64 `protobuf:"fixed64,16,opt,name=Featured,proto3" json:"Featured,omitempty"`
}
...
func (x *LaptopCard) GetFeatured() float64 {
	if x != nil {
		return x.Featured
	}
	return 0
...
var file_api_catalog_catalog_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x64, 0x18, 0x10, 0x20, 0x01, 0x28, 0x01, 0x52, 0x08, 0x46, 0x65, 0x61, 0x74, 0x75,
